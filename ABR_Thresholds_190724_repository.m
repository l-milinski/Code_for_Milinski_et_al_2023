...
% The subsequent sections use metadata based on manual threshold 
...
cmap = [.5 .5 1; 1 .5 .5; 0.8 0.5 0]; %edit 200624
...
Markers = {'+','o','*','x','v','d','^','s','>','<'};
if time == 1 || time  == 2
        display 'time is 1 or 2'
    for anm = 1:7
    plot([1 2 3 4 5 6]+t,[Thresholds(6,IdxTS{time}{1}(anm))' Thresholds(6,IdxTS{time}{2}(anm))' Thresholds(6,IdxTS{time}{4}(anm))' Thresholds(6,IdxTS{time}{8}(anm))'...
        Thresholds(6,IdxTS{time}{16}(anm))' Thresholds(6,IdxTS{time}{20}(anm))'],[strcat(Markers{anm})],'Color',cmap(count,:),'Markersize',7,'linewidth',1.5);
    end
elseif time == 3
        display 'time is 3'
    for anm = 1:3
    plot([1 2 3 4 5 6]+t,[Thresholds(6,IdxTS{time}{1}(anm))' Thresholds(6,IdxTS{time}{2}(anm))' Thresholds(6,IdxTS{time}{4}(anm))' Thresholds(6,IdxTS{time}{8}(anm))'...
        Thresholds(6,IdxTS{time}{16}(anm))' Thresholds(6,IdxTS{time}{20}(anm))'],[strcat(Markers{anm+4})],'Color',cmap(count,:),'Markersize',7,'linewidth',1.5);
    end
end
...
legend([b1(1) b1(2) b1(3)],'BL','1 week','6 months','location','southwest')
