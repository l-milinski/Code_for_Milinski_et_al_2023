...
%% FIGURE 1B: Plot thresholds over time
...
plot([1 3], [17 17],'-k','linewidth',1) % line post2
plot(mean([1 3])-0.1, 17.5, '*k','Markersize',7,'linewidth',1.1) % marker1
plot(mean([1 3]), 17.5, '*k','Markersize',7,'linewidth',1.1) % marker2
plot(mean([1 3])+0.1, 17.5, '*k','Markersize',7,'linewidth',1.1) % marker2
...
% end
    ...
    xticks([1 2 3])
    xticklabels({'Baseline', 'Post 1','Post 2'})
